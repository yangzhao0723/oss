...
public class BaseDAO<T> {
    ...
    public List<T> queryForPage1(Class<?> c, String sql, int pageIndex, int pageSize) {
        List<T> result = null;
        Session session = null;
        try {
            session = sessionFactory.getCurrentSession();
    ...
    public int queryRecordCount1(String sql,final Object... objects) {
        int result = 0;
        Session session = null;
        try {
            session = sessionFactory.getCurrentSession();
    ...
    public List<T> findBySql1(String sql, final Object... objects) {
        List<T> result = null;
        Session session = null;
        try {
            session = sessionFactory.getCurrentSession();
    ...
    public List<T> findByHql1(String hql, final Object... objects) {
     ...
     @Transactional
    public int  extcuteHQL(String hql, final Object... objects) {
        int result =0;
        Session session = null;
        try {
            session = sessionFactory.getCurrentSession();
    ...
    @Transactional
    public int delBySql(String sql, final Object... objects) {
        int result = 0;
        Session session = null;
        try {
            session = sessionFactory.getCurrentSession();
            Query del = session.createSQLQuery(sql);
            for (int i = 0; i < objects.length; i++) {
                del.setParameter(i, objects[i]);
            }
